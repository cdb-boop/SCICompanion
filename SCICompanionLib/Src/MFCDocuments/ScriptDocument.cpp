...
{
	// Calculate errors;
	_cErrors += (int)count_if(_compileResults.begin(), _compileResults.end(), mem_fn(&CompileResult::IsError));
	_cWarnings += (int)count_if(_compileResults.begin(), _compileResults.end(), mem_fn(&CompileResult::IsWarning));
}
